...
export default function EcommerceSalesOverviewByTier({ title, subheader, data, ...other }: Props) {
  return (
    <Card {...other}>
    ...
    <Stack spacing={1}>
      <Stack direction="row" alignItems="center">
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
          &nbsp;{fNumber(progress.value)}
        </Typography>
      </Stack>

      <LinearProgress variant="determinate" value={progress.value} color="primary" />
    </Stack>
  );
}
